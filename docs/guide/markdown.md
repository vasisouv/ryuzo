...
You may also customize syntax highlight theme in app config. Please see [`markdown` options](components/app-configs#markdown) for more details.
...
Please see [`markdown` options](components/app-configs#markdown) for more details.
...
See full list of configurable properties in [Configs: App Configs](components/app-configs#markdown).
